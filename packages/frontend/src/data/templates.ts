...
export const workflowTemplates: WorkflowTemplate[] = [
  {
    ...
    name: "创建新品并上架到Amazon",
    description:
      "从GigaB2B抓取商品，AI识别图片，优化文案，自动上架到Amazon后台",
    category: "publish",
    categoryLabel: "上架管理",
  ...
  },
  {
    ...
    name: "关键词挖掘与分析",
    description:
      "AI识别图片提取关键词，搜索Amazon竞品，挖掘西柚找词数据并优化文案",
    category: "research",
    categoryLabel: "市场调研",
  ...
  },
  {
    ...
    name: "Amazon 自动化选品优化",
    description:
      "完整 6 步流水线：GigaB2B 爬取 → AI 识图提取关键词 → Amazon 竞品搜索 → 商品详情抓取 → 西柚找词 → AI 文案优化",
    category: "research",
    categoryLabel: "市场调研",
    ...
    defaultConfigs: {
      "gigab2b-crawl": {
        productUrl:
          "https://www.gigab2b.com/index.php?route=product/product&product_id=928649",
      },
